...
<body><div style = "display: flex;
  ...
  justify-content: center;"><div style="height:95%; aspect-ratio: %9/%10;"
id="gd"></div></div>
<script>
%1
%2
...
<body><div style = "display: flex;
  align-items:center;height:100%; width:100%;background:#dddfd4;
  justify-content: center;"><div style="height:95%; aspect-ratio: %4/%5;"
id="gd"></div></div>
...
<body><div style = "display: flex;
  align-items:center;height:100%; width:100%;background:#dddfd4;
  justify-content: center;"><div style="height:95%; aspect-ratio: %7/%8;"
id="gd"></div></div>
<script>
...
<body><div style = "display: flex;
  align-items:center;height:100%; width:100%;background:#dddfd4;
  justify-content: center;"><div style="height:95%; aspect-ratio: %5/%6;"
id="gd"></div></div>
<script>
var trace = {
x:[%2],
