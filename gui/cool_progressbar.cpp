...
coolProgressBar::coolProgressBar(const QColor &backgroundColor,
                                 ...
                                 int animationTimeMs, QWidget *parent) {
  setVisible(false);
  m_backgroundColor = backgroundColor;
  m_animatedColor = animatedColor;
  m_animationTimeMs = animationTimeMs;
  QString styleBack("    background-color: %1;"
                    "    border-radius: 1px;"
                    "    border: none;");
  ...
  QString styleMoving("    background-color: %1;"
                      "    border-radius: 1px;"
                      "    border: none;");
...
void coolProgressBar::startAnimation() {
  m_animation->setStartValue(QRect(-m_movingSquare->width(),
                                   m_movingSquare->y(), m_movingSquare->width(),
                                   m_movingSquare->height()));
  m_animation->setEndValue(QRect(width(), m_movingSquare->y(),
