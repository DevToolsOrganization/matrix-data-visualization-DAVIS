...
AnimatedButton::AnimatedButton(const QString &text, QColor startColor,
  ...
  connect(this, &QPushButton::pressed, this,
          &AnimatedButton::animateButtonPress);
  connect(this, &QPushButton::released, this,
          &AnimatedButton::animateButtonRelease);
}
...
void AnimatedButton::animateButtonPress() {
  ...
  animation->setEndValue(
      QRect(m_originalGeometry.x(), m_originalGeometry.y() + 5,
...
QColor AnimatedButton::backgroundColor() const { return m_backgroundColor; }
