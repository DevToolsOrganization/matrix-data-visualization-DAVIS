...
About_window::About_window(QWidget *parent)
    : QMainWindow(parent), ui(new Ui::about_window) {
  ui->setupUi(this);
...
void About_window::on_pushButton_close_clicked() { close(); }
...
bool About_window::eventFilter(QObject *o, QEvent *e) {
  if (o == ui->label_DevtoolsDavis &&
      e->type() == QMouseEvent::MouseButtonRelease && !isMusicPlaying) {
    qint64 delta_ms = 250;
